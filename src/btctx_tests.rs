...
#[test]
fn parse_txid() {
    let tx = parse("");
    assert_eq!(
        hex::encode(tx.hash()),
...
fn parse_witness_txid() {
    let tx = parse("");
    assert_eq!(
        hex::encode(tx.hash()),
...
fn p2pk_and_p2wpkh_bip143() {
    ...
    assert_eq!(hex::encode(&s1), "00141d0f172a0ecb48aee1be1f2687d2963ae33f71a1");
...
fn p2sh_p2wpkh() {
    ...
    let mut tx = parse("0100000001db6b1b20aa0fd7b23880be2ecbd4a98130974cf4748fb66092ac4d3ceb1a54770100000000feffffff02b8b4eb0b000000001976a914a457b684d7f0d539a46a45bbc043f35b59d0d96388ac0008af2f000000001976a914fd270b1ee6abcaea97fea7ad0402e8bd8ad6d77c88ac92040000");
...
fn p2wsh_autodetect() {
    ...
    let key1 = key("619c335025c7f4012e556c2a58b2506e30b8511b53ade95ea316fd8c3286feb9");
    let mut tx = parse(BIP143_TX);
    tx.in_[1].script = Script::new(key1.public_key()).generate("p2wsh:p2pkh").unwrap();
    tx.sign(&[
        BtcTxSign::new(&key0, "p2pk"),
...
fn compute_size_prefill_ge_signed() {
    let key0 = key("bbc27228ddcb9209d7fd6f36b02f7dfa6252af40bb2f1cbc7a557da8027ff866");
    let key1 = key("619c335025c7f4012e556c2a58b2506e30b8511b53ade95ea316fd8c3286feb9");
    for scheme in ["p2wsh", "p2wsh:p2pk", "p2wsh:p2pkh", "p2wsh:p2puk", "p2wsh:p2pukh"] {
        ...
        let sign_scheme = if scheme == "p2wsh" { "p2wsh:p2pkh" } else { scheme };
        sig_tx
            .sign(&[
                BtcTxSign::new(&key0, "p2pk"),
...
fn extract_and_verify_p2pkh() {
    ...
    let digest = tx.input_sighash(0, &sigs[0], &prev_script, crate::BtcAmount(0)).unwrap();
    let der = &{
